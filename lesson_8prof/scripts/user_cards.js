...
users
  .filter(({ age }) => age > 30)
  .forEach(({ firstname, lastname, age, photo, active, email }) => {
    ...
    cardElem.classList.add("usersss");
    cardElem.append(photoElem, nameElem, ageElem, emailElem);
    cards_container.append(cardElem);
    cardElem.style.backgroundColor = active ? "lightgreen" : "darkgreen";
    cardElem.style.border = active
      ? "7px solid lightgray"
      : "7px solid darkgray";
  });
